...
|- [Turn off screen rotation](#_turn_off_screen) (and stay in portrait or landscape always)|x||||TBD|
|- [Spotlight searches include MyTalkTools content](#_spotlight_searches_include)|x||||TBD|
